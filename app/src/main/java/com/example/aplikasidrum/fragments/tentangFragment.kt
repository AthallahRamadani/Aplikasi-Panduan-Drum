...
import kotlinx.android.synthetic.main.fragment_tentang.*
...
class tentang : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        biografi.setOnClickListener{
            activity?.let{
                val intent = Intent (it, BiografiActivity::class.java)
                it.startActivity(intent)
            }
        }
        list.setOnClickListener{
            activity?.let{
                val intent = Intent (it, ListdrummerActivity::class.java)
                it.startActivity(intent)
            }
        }
        kontak.setOnClickListener{
            activity?.let{
                val intent = Intent (it, KontakActivity::class.java)
                it.startActivity(intent)
            }
        }
